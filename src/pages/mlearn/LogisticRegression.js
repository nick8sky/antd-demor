    ...
    render() {
        return (
            <div>
                ...
                <p><img src="http://i4.bvimg.com/633340/c5f62160a710ae21.png" style={{height:"40%",width:"40%"}}/></p>
                ...
                <p><img src="http://i4.bvimg.com/633340/672488f8363c05c7.png" style={{height:"40%",width:"40%"}}/></p>
               ...
               {/* <p><img src={require('../../img/20151014124124641.png')} style={{height:"40%",width:"40%"}}/></p>*/}
                ...
                <p><img src="http://i4.bvimg.com/633340/d5225eea47bf03c3.png" style={{height:"40%",width:"40%"}}/></p>
                <p>有时候是这个样子：</p>
                {/*<p><img src={require('../../img/20151014124156527.png')} style={{height:"40%",width:"40%"}}/></p>*/}

                <p><img src="http://i4.bvimg.com/633340/5312f5d117049598.png" style={{height:"40%",width:"40%"}}/></p>
                <p>甚至可能是这个样子：</p>
                {/*<p><img src={require('../../img/20151014124241795.png')} style={{height:"40%",width:"40%"}}/></p>*/}

                <p><img src="http://i4.bvimg.com/633340/6d84be1ebbbea79e.png" style={{height:"40%",width:"40%"}}/></p>
                ...
                <p><img src="http://i4.bvimg.com/633340/b347faa89238558d.png" style={{height:"40%",width:"40%"}}/></p>
                <p>记cost为l(loss)：</p>
                ...
                <p><img src="http://i4.bvimg.com/633340/6ddc7c396bd5835d.png" style={{height:"40%",width:"40%"}}/></p>
                <h4>非凸优化问题</h4>
