    ...
    render() {
        return (
            <div>
                ...
                <p>一棵简单的B树示意图如下： </p>
                <p><img src={require('../../img/8394323_130745821166Sc.jpg')} /></p>
                ...
                <p><img src={require('../../img/20160427111429453.png')} /></p>
                <p>如此时插入A, 最终会插入到y节点。而y节点已经有3个关键字，因此在插入之前必须先将y分裂成两个节点，并将H提升到父节点中 。</p>
                <p><img src={require('../../img/20160427111537360.png')} /></p>
                <p>总结：
                    1）先往叶子节点中插入
                ...
                <p><img src={require('../../img/20160427125613010.png')} /></p>
                <p>
